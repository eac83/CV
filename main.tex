...
\resumeSubHeadingListStart
    ...
    \resumeSubheadingTwo
        {University of Cambridge, Robinson College}{10/2019 -- 07/2023}
        {MSci in Astrophysics}{1st Class with Distinction}
        {BA (Hons) in Natural Sciences}{1st Class}
%\begin{comment}
    \resumeSubheading
        {King Edward VI School}{09/2012 -- 07/2019}
...
\resumeSubheading
        {Powerful AGN outflows at cosmic noon can solve the S8 tension?}{10/2022 -- 05/2023}
        {Master's Project}{}
      \resumeItemListStart
        \small\resumeItem{Explored powerful AGN outflows from supermassive black holes to see if these can help solve the \(S_8\) tension, a prominent problem in cosmology.}
        \resumeItem{Reviewing literature around baryonic effects on the matter power spectrum.}
        \resumeItem{Running simulations and analysing and transforming simulation data of over 100 million particles in Python on a large computer cluster.}
        \resumeItem{Presented project findings in a 20 minute presentation and in a 30 page report.}
    \resumeItemListEnd
\resumeSubheading
        {CATAM II}{10/2021 -- 05/2022}
        ...
        \resumeItemListStart
            ...
            \resumeItem{\textbf{Accretion Disks}: Evolved an accretion disk orbiting a massive object for 10 million time steps.}
        \resumeItemListEnd
\resumeSubheading
...
\resumeSubheading
    ...
    \resumeItemListStart
        ...
        \resumeItem{Organised weekly society meetings with the rest of the committee.}
    \resumeItemListEnd
\begin{comment}
    \resumeSubheading
